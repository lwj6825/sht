    ...
    <div class="content nodeCompare">
        ...
        <div class="table">
            ...
            <el-table :data="tableData" :header-cell-style="rowClass">
                <el-table-column prop="id" label="节点编码"></el-table-column>
                <el-table-column prop="id" label="节点名称"></el-table-column>
                <el-table-column prop="id" label="自定义节点编码"></el-table-column>
                <el-table-column prop="id" label="自定义节点名称"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        editFun(ele){
            this.$router.push({name: 'EditNodeCompare'})
        },
        deleteFun(ele){
