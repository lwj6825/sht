    ...
    <div class="content bizCompare">
        ...
        <div class="table">
            ...
            <el-table :data="tableData" :header-cell-style="rowClass">
                <el-table-column prop="id" label="商户编码"></el-table-column>
                <el-table-column prop="id" label="商户名称"></el-table-column>
                <el-table-column prop="id" label="自定义商户编码"></el-table-column>
                <el-table-column prop="id" label="自定义商户名称"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        editFun(ele){
            this.$router.push({name: 'EditBizCompare'})
        },
        deleteFun(ele){
