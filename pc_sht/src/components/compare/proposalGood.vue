<template>
    <div class="content proposalGood">
            ...
            <el-table :data="tableData" :header-cell-style="rowClass">
                ...
                <el-table-column label="操作" width="100">
                    <template slot-scope="scope">
                        ...
                        <el-button type="text" size="small" @click="closeFun(scope.row)">开启上报</el-button>
                    </template>
                </el-table-column>-->
            </el-table>
...
import {GetGoodsTypes, QueryProposalReportNodeGoods, DownloadProposalReportNodeGoods} from '../../js/compare/compare.js'
export default {
    name:"proposalGood",
    data() {
        return {
    ...
    methods: {
        ...
        downloadFun(){
            ...
            DownloadProposalReportNodeGoods( params, {})
                .then((res) => {
                    ...
                    aLink.href = url;
                    aLink.setAttribute("download", `建议上报商品` + time);
        ...
        getDataFun(){
            ...
            QueryProposalReportNodeGoods(obj)
                .then(res => {
                    this.loading = false
