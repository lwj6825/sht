<template>
  <div class="syacontent">
      ...
      <div class="title_row">
        ...
        <div class="title_row_left">
          ...
          <el-select v-model="pz_name_local" slot="append" placeholder="请选择" size="small" style="width: 200px">
            <el-option v-for="item in tableSymReviewList_variety" :key="item.id" :label="item.pz_name"
                       :value="item.pz_name"></el-option>
          </el-select>
        </div>

        <!-- <div class="title_row_left">
          <span>企业名称:</span>
          <el-input v-model="place_name_local" placeholder="请输入内容" size="small"></el-input>
        </div> -->
    ...
    <!--&lt;!&ndash;<el-input v-model="place_name" placeholder="输入地块名称" size="small" style="width: 200px"></el-input>&ndash;&gt;-->
    ...
    <!--&lt;!&ndash;<el-select v-model="hzs_name_local" slot="append" placeholder="请选择" value-key="userId"&ndash;&gt;-->
    <!--&lt;!&ndash;class="select-width-me-one" size="small" clearable filterable style="width: 200px">&ndash;&gt;-->
    <!--&lt;!&ndash;<el-option v-for="item in plotHzsDataList" :key="item.userId" :label="item.booth_name"&ndash;&gt;-->
    <!--&lt;!&ndash;:value="item"></el-option>&ndash;&gt;-->
    ...
    <!--&lt;!&ndash;v-model="cjsj"&ndash;&gt;-->
    <!--&lt;!&ndash;type="date"&ndash;&gt;-->
    <!--&lt;!&ndash;value-format="yyyy-MM-dd"&ndash;&gt;-->
    <!--&lt;!&ndash;placeholder="选择日期" class="my-el-date-picker" size="small" style="width: 200px">&ndash;&gt;-->
    <!--&lt;!&ndash;</el-date-picker>&ndash;&gt;-->
    ...
    <!--<div class="lz-filter-name-two" ></div>-->
    <!--&lt;!&ndash;<el-select v-model="hzs_name_local" slot="append" placeholder="请选择" value-key="userId"&ndash;&gt;-->
    <!--&lt;!&ndash;class="select-width-me-one" size="small" clearable filterable style="width: 200px">&ndash;&gt;-->
    <!--&lt;!&ndash;<el-option v-for="item in plotHzsDataList" :key="item.userId" :label="item.booth_name"&ndash;&gt;-->
    <!--&lt;!&ndash;:value="item"></el-option>&ndash;&gt;-->
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            ...
            <el-button
              ...
              type="text"
              id="open_btn"
              v-if="scope.row.review_state==='2'"
              @click="reviewSendId(scope.$index, scope.row)">审核
            </el-button>
            ...
            <el-button
              ...
              type="text "
              class="xiazaicolor"
              v-if="scope.row.review_state==='1'"
              @click="downloadtxt(scope.$index, scope.row)">下载
            </el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog
      ...
      <div class="tjsf-div2-row">
        ...
        <div class="right">
          ...
          <el-select v-model="ifpassname" slot="append" placeholder="请选择" value-key="id" class="select-width-me"
                     clearable>

            <el-option v-for="item in if_pass_list" :key="item.value" :label="item.name"
