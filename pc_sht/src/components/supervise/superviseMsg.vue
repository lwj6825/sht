<template>
    <div class="content superviseMsg">
        ...
        <div class="table">
            ...
            <div class="password" v-if="isView">
                <div class="text">
                    ...
                    <div class="btn">
                        <el-button @click="closeFun4" style="margin-left: 500px;">取消</el-button>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        getViewFun(node_id){
            ...
            //             // that.title.forEach(val => {
            //             //     res.data.regionList.forEach(val2 => {
            //             //         if(val.shop_booth_id == val2.SHOP_BOOTH_ID){
            //             //             console.log(111)
            //             //             that.regionArr.push(val2)
            //             //         }
            //             //     })
            //             // })
            //         })
