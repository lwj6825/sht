                ...
                <div class="text">
                    ...
                    <div class="msg-box">
                        ...
                        <!--<div class="data">
                            ...
                            <div class="msg">
                                <el-select v-model="region" clearable filterable placeholder="请选择" @change="selectRegion">
                    ...
                    <!--<div class="tips">先选区域，再选商户</div>
                    <el-tabs v-model="activeName" @tab-click="handleClick" v-if="region == ''">
                    ...
                    <div class="table">
                        <el-table :data="tableData2" :header-cell-style="rowClass" height="280">
                            ...
                            <el-table-column prop="price" label="销售价（元/公斤）">
                                <template slot-scope="scope">
                                    <div class="num">
                                        <div>
                            ...
                            <el-table-column label="操作" width="60">
                                <template slot-scope="scope">
                                    <el-button type="text" size="small" v-if="allGood.length == 0" @click="submitForm(scope.row)">提交</el-button>
                                </template>
                            </el-table-column>
                        </el-table>
...
export default {
    ...
    methods: {
        ...
        getNodeFun(){
            GetAllNode()
                .then(res => {
                    ...
                    this.tbqyArr.forEach(val => {
                        if(this.form.enterprise == val.node_id){
                            this.tbqyUserId = val.userId
                        }
                    })
                })
        ...
        viewFun(ele){
            ...
            this.tbshView = ele.booth_name
            this.viewNodeId = this.form.enterprise
            this.viewBiz = ele.shop_booth_id
            this.region = Number(ele.region)
            this.merchant = ele.shop_booth_id
            this.biz_id = ele.biz_id
            this.biz_name = ele.booth_name
            this.in_date = ele.in_date
            this.getViewFun(this.form.enterprise)
        },
        // 查看
        getViewFun(node_id){
            let obj = {
