<template>
  <div class="syacontent">
    ...
    <div class="viewcentent">
      ...
      <div class="plot-info">
        ...
        <div class="plot-info-one-row">
          ...
          <div class="columnthree">地块介绍：{{dkjs}}</div>
        </div>
        <div class="plot-info-one-row">
            ...
            <el-tab-pane label="土壤施肥" name="first" class="one">
              ...
              <div class="sf-table">
                <el-table :data="viewTrsfList" style="width: 100%" :cell-style = "getRowheight" :header-cell-style="getRowClass">
                  ...
                  <el-table-column prop="trsf_describe" label="图片"> </el-table-column>
    ...
    <!--新增土壤施肥-->
    <el-dialog title="添加施肥记录" :visible.sync="centerEditDialogVisible" :before-close="handleClose" :close-on-click-modal = "isclick"
      width="650px">
      <!--肥料名称-->
    ...
    <!--编辑土壤施肥-->
    <el-dialog title="编辑施肥记录" :visible.sync="editTrsfFlag" :before-close="handleClose" :close-on-click-modal = "isclick"
      width="650px">
      <!--肥料名称-->
      <div class="tjsf-div2-row">
        <div class="left">肥料名称:</div>
      ...
      <div class="tjsf-div2-row">
        ...
        <div class="right">
          ...
          class="my-el-date-picker"> </el-date-picker>
        </div>
      </div>
      <!--生产单位-->
      <div class="tjsf-div2-row">
      ...
      <div class="tjsf-div2-row">
        <div class="left">描述:</div>
        <div class="right">
          <el-input v-model="trsf_describe_add" placeholder="请输入内容" type="textarea" :rows="2"></el-input>
        </div>
      </div>
      <div class="tjsf-div2-row">
        <div class="left">上传图片:</div>
    ...
    <!--新增病虫害防治   bchflag-->
    <el-dialog title="病虫害防治记录" :visible.sync="bchflag" :before-close="handleClose" :close-on-click-modal = "isclick"
      width="650px">
      <!--内容-->
      <!--肥料名称-->
      <div class="tjsf-div2-row">
      ...
      <div class="tjsf-div2-row">
        ...
        <div class="right">
          <el-date-picker v-model="in_date_bch_add" type="date" size="large" value-format="yyyy-MM-dd"
            placeholder="选择日期" class="my-el-date-picker"> </el-date-picker>
        </div>
      </div>
      <!--生产单位-->
      <div class="tjsf-div2-row">
    ...
    <!--编辑病虫害防治   bchflag-->
    <el-dialog title="编辑病虫害防治记录" :visible.sync="editBchflag" :before-close="handleClose" :close-on-click-modal = "isclick"
      width="650px">
      <!--内容-->
      <!--肥料名称-->
      <div class="tjsf-div2-row">
    ...
    <!--新增农事记录   nsjlflag-->
    <el-dialog title="添加农事记录" :visible.sync="nsjlflag" :before-close="handleClose" :close-on-click-modal = "isclick"
      width="650px">
      <!--农事日期-->
      <div class="tjsf-div2-row">
      ...
      <div class="tjsf-div2-row">
        ...
        <!--<el-input v-model="input" placeholder="请输入内容" class="right"></el-input>-->
        <div class="right">
          <el-select v-model="nsTypes" clearable placeholder="请选择">
    ...
    <!--编辑农事记录   nsjlflag-->
    <el-dialog title="编辑农事记录" :visible.sync="editNsjlflag" :before-close="handleClose" :close-on-click-modal = "isclick"
      width="650px">
      <!--农事日期-->
      <div class="tjsf-div2-row">
        <div class="left">农事日期:</div>
