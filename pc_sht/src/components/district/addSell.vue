    ...
    <div class="section-content">
        <el-form  label-width="120px"  :model="form" ref="form" :rules="rules" style="width: 500px;margin-left: 150px;">
            ...
            <el-form-item label="价格：" prop="price">
                <el-input style="width: 240px" v-model="form.price"></el-input>
                <span >&nbsp;&nbsp;元</span>
            </el-form-item>
            ...
            <el-form-item label="供应商：" prop="suppliersId">
                <el-select v-model="form.suppliersId" placeholder="请选择供应商" >
...
import {AddSell} from '../../js/district/district.js'
