    ...
    <div class="content">
          <div class="search">
                <el-form ref="form" :inline="true" :model="form" label-width="100px">
                    ...
                    <el-form-item label="供货单位：" prop="dataSou">
                        <el-select class="label-width" v-model="form.supplier" placeholder="请选择"  @change="selectGet"  >
                                    <el-option v-for="(item,index) in options" :key="index" :label="item.text" :value="item.id">
                                    </el-option>
                        </el-select>
                    </el-form-item> 
                    <el-form-item label="标签编码：">
                        <el-input v-model="form.labelCode" placeholder="请输入物品编码" style="width:230px"></el-input>
                    </el-form-item>
          ...
          <div class="tables" v-loading.body="fullscreenLoading">
                ...
                <div class="table-box">
                    <el-table :data="tableData" :header-cell-style="rowClass" >
                        ...
                        <el-table-column prop="node_name" label="供货单位名称" align="left"> </el-table-column>
                        <el-table-column prop="legal_represent" label="产地名称" align="left"> </el-table-column>
                        <el-table-column prop="tel" label="信息更新时间" align="left"> </el-table-column>
                        <el-table-column prop="addr" label="标签编码" align="left"> </el-table-column>
                        <el-table-column prop="icon" label="备注" align="center" ></el-table-column>
