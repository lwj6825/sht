<template>
    <div class="content reportGwzxList">
        ...
        <div class="popup" v-if="isView">
            <div class="text">
                ...
                <div class="box-msg">
                    ...
                    <div class="msg-table">
                        <el-table :data="tableData2" :header-cell-style="rowClass" height="354">
                            ...
                            <el-table-column prop="node_id" label="餐饮销售（万元）" align="center">
                                <el-table-column prop="saleroom_cater" :label="current_year + '年'" align="center"></el-table-column>
                                <el-table-column prop="saleroom_cater_old" :label="last_year + '年'" align="center"></el-table-column>
                                <el-table-column prop="saleroom_cater_on" label="同比(%)">
                                    <template slot-scope="scope">
                                        {{scope.row.saleroom_cater_on != 0  && scope.row.saleroom_cater_on != null ? scope.row.saleroom_cater_on + '%' : scope.row.saleroom_cater_on}}
                                    </template>
                                </el-table-column>
                            </el-table-column>
                        ...
                        <div class="tips">
                            <p class="total">在营业的商户总数{{biz_total}}家，其中餐饮商户数为{{cy_biz}}家</p>
                        </div>
                    </div>
                    <div class="btn">
                ...
                <div class="box-msg">
                    ...
                    <div class="msg-table">
                        <div style="height: 368px; overflow:auto;">
                            <el-table :data="tableData3" :header-cell-style="rowClass" height="368">
                                <el-table-column prop="time" width="90" label="日期" align="center"></el-table-column>
                                <el-table-column prop="sale" label="总销售额（万元）" align="center">
                                    <el-table-column prop="sale_current" :label="current_year + '年'" width="100" align="center">
                                        <template slot-scope="scope">
                                            ...
                                            <p class="increase none" v-if="scope.row.sale_rate < 20 && scope.row.catering_rate > 20"></p>
                                        </template>
                                    </el-table-column>
                                    <el-table-column prop="sale_last" :label="last_year + '年'" width="100" align="center">
                                        <template slot-scope="scope">
                                ...
                                <el-table-column prop="catering" label="餐饮销售（万元）" align="center">
                                    <el-table-column prop="catering_current" :label="current_year + '年'" width="100" align="center">
                                        <template slot-scope="scope">
                                            <el-input v-model="scope.row.catering_current"></el-input>
                                            <p class="increase" v-if="scope.row.catering_rate > 20">较昨日+{{scope.row.catering_rate}}%</p>
                                            <p class="increase none" v-if="scope.row.sale_rate > 20 && scope.row.catering_rate < 20"></p>
                                        </template>
                                    </el-table-column>
                                    <el-table-column prop="catering_last" :label="last_year + '年'" width="100" align="center">
                                        <template slot-scope="scope">
                                            <el-input v-model="scope.row.catering_last"></el-input>
                                            <p class="increase none" v-if="scope.row.sale_rate > 20 || scope.row.catering_rate > 20"></p>
                                        </template>
                                    </el-table-column>
                                </el-table-column>
                                <el-table-column prop="passenger_flow" label="客流（人）" align="center">
                                    <el-table-column prop="passenger_flow_current" :label="current_year + '年'" width="100" align="center">
                                        <template slot-scope="scope">
                                            <el-input v-model="scope.row.passenger_flow_current" @input="inputFun"></el-input>
                                            <p class="increase none" v-if="scope.row.sale_rate > 20 || scope.row.catering_rate > 20"></p>
                                        </template>
                                    </el-table-column>
                                    <el-table-column prop="passenger_flow_last" :label="last_year + '年'" width="100" align="center">
                                        <template slot-scope="scope">
                                ...
                                <el-table-column prop="passenger_price" label="客单价（元/人次）" align="center">
                                    <el-table-column prop="passenger_price_current" :label="current_year + '年'" width="100" align="center">
                                        <template slot-scope="scope">
                                            <el-input v-model="scope.row.passenger_price_current"></el-input>
                                            <p class="increase none" v-if="scope.row.sale_rate > 20 || scope.row.catering_rate > 20"></p>
                                        </template>
                                    </el-table-column>
                                    <el-table-column prop="passenger_price_last" :label="last_year + '年'" width="100" align="center">
                                        <template slot-scope="scope">
                                ...
                                <el-table-column prop="start_num" label="开工人数（人）" width="100" align="center">
                                    <template slot-scope="scope">
                                        <el-input v-model="scope.row.start_num"></el-input>
                                        <p class="increase none" v-if="scope.row.sale_rate > 20 || scope.row.catering_rate > 20"></p>
                                    </template>
                                </el-table-column>
                                <el-table-column prop="new_start_num" label="新增人数（人）" width="100" align="center">
                                    <template slot-scope="scope">
                        ...
                        <div class="tips">
                            <div class="total">
                                ...
                                <span>家，其中餐饮商户数为</span>
                                <el-input v-model="cy_biz"></el-input>
                                <span>家</span>
                            </div>
        ...
        'tableData3': {
            handler: function(newVal,oldVal){
                newVal.forEach((v, idx) => {
                    ...
                    if(v.catering_current){
                        num3 += v.catering_current;
                        v.catering_current = num3.replace(/[^\d.]/g,'')
                    }
                    if(v.catering_last){
                        num4 += v.catering_last;
                        v.catering_last = num4.replace(/[^\d.]/g,'')
                    }
                    ...
                    if(idx == 6){
                        if(this.oldDayArr.length > 0){
                            if(this.oldDayArr[0].saleroom_cater && this.oldDayArr[0].saleroom_cater != 0){
                                let num = ((newVal[idx].catering_current - this.oldDayArr[0].saleroom_cater)/this.oldDayArr[0].saleroom_cater)*100;
                                newVal[idx].catering_rate = this.strFun(num.toFixed(2))
                            }else{
                                newVal[idx].catering_rate = 0
                            }
                        ...
                        if(newVal[idx + 1].catering_current && newVal[idx + 1].catering_current != 0){
                            let num = ((newVal[idx].catering_current - newVal[idx+1].catering_current)/newVal[idx+1].catering_current)*100;
                            newVal[idx].catering_rate = this.strFun(num.toFixed(2))
                        }else{
                            newVal[idx].catering_rate = 0
                        }
            ...
            GetSavedReport(obj)
                .then(res => {
                    ...
                    this.tableData3.forEach((val, idx) => {
                        // console.log(this.tableData3[idx])
                        if(idx + 1 < 7){
                        //     console.log(111)
        ...
        saveFun(){
            ...
            this.tableData3.forEach(val => {
                if(state){
                    ...
                    if(val.catering_current == '' || val.catering_current == null){
                        // this.$message.warning('请输入' + this.current_year + '年' + val.time + '餐饮销售额');
                        this.$message.warning('请填写所有数据后保存');
                        state = false;
                        return;
                    }
                    if(val.catering_last == '' || val.catering_last == null){
                        // this.$message.warning('请输入' + this.last_year + '年' + val.time + '餐饮销售额');
                        this.$message.warning('请填写所有数据后保存');
                        state = false;
                        return;
                    }
            ...
            if(state){
                ...
                this.tableData3.forEach(val => {
                    msgObj = {
                        ...
                        saleroom_cater: val.catering_current, // 餐饮销售额
                        saleroom_cater_old: val.catering_last,
                        saleroom_cater_on: val.catering_rate,
                        user_id: this.userId,
                        shop_id: this.shop_id,
