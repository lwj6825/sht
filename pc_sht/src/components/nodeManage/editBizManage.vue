<template>
    <div class="content editBizManage">
...
<script>
import { QueryBusinessTypeSelect, QueryNodeSelect, QuerypropertySelect, GetBizIdByCondition, UpdateBusiness} from '../../js/nodeManage/nodeManage.js'
export default {
    name:"editBizManage",
    data() {
        return {
    ...
    mounted() {
        ...
        this.form.node_id = routeObj.node_id
        this.form.node_name = routeObj.node_name
        this.form.biz_id_old = routeObj.biz_id
        this.form.biz_code = routeObj.biz_id
        this.form.biz_name = routeObj.biz_name
        this.form.id_card = routeObj.reg_id
        this.form.credit_code = routeObj.social_credit_code
        this.form.nature = routeObj.property_name
        this.form.types = routeObj.type_id
        this.form.people = routeObj.legal_represent
        this.form.phone = routeObj.tel
        this.form.ic_code = routeObj.ick
        this.form.remake = routeObj.remark
    },
    methods: {
        // 选择企业
        selectNodeFun(ele){
